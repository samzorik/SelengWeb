...
//		defaultcategorydataset.addValue(100D, "Israel", "Asia");
		for (int i = 0; i < data.length; i++) {
			for (int j = 0; j < data[i].length; j++) {
				defaultcategorydataset.addValue(1, data[i][j], "Кластер "+(i+1));
			}
		}
	...
	{
		JFreeChart jfreechart = ChartFactory.createStackedBarChart("Гистограмма кластеров", null, null, categorydataset, PlotOrientation.VERTICAL, false, true, false);
...
//		mystackedbarrenderer.
	...
	{
		ItemLabelDemo5 itemlabeldemo5 = new ItemLabelDemo5("Гистограмма кластеров");
		itemlabeldemo5.pack();
