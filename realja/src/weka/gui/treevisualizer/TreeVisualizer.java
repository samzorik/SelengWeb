...
public class TreeVisualizer
  ...
  public TreeVisualizer(TreeDisplayListener tdl, String dot, NodePlace p) {
    ...
    if (m_ShowBorder)
      setBorder(BorderFactory.createTitledBorder("Обзор дерева")); 
    m_listener = tdl;
    ...
    */
    ...
    /* A visualize choice for the node, may not be available. */
    m_visualise = new JMenuItem("Отобразить вершину");
