...
public class AttributeSelectionPanel
  ...
  class AttributeTableModel
	...
	return new String("");
      case 2:
	return new String("Название атрибута");
      default:
	return null;
      }
    }
  ...
  protected JButton m_IncludeAll = new JButton("Все");

  /** Press to deselect all attributes */
  protected JButton m_RemoveAll = new JButton("Ни одного");

  /** Press to invert the current selection */
  protected JButton m_Invert = new JButton("Инвертировать");

  /** Press to enter a perl regular expression for selection */
 // protected JButton m_Pattern = new JButton("Шаблон");
  ...
  public AttributeSelectionPanel(boolean include, boolean remove, boolean invert,
    ...
    m_IncludeAll.setToolTipText("Выбор всех атрибутов");
    ...
    m_RemoveAll.setToolTipText("Отмена выбора атрибутов");
    ...
    m_Invert.setToolTipText("Инвертирование текущего выбора атрибутов");
...
//    m_Pattern.setToolTipText("Выбор атрибутов согласно регулярному выражению");
...
//              m_Pattern.getParent(),
//              "'" + pattern + "'не регулярное выражение Перл!\n" 
//              + "Error: " + ex, 
//              "Error in Pattern...", 
