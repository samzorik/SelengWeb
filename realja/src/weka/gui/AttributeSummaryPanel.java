...
public class AttributeSummaryPanel 
  ...
  public AttributeSummaryPanel() {
    ...
    JLabel lab = new JLabel("Название:", SwingConstants.RIGHT);
    ...
    lab = new JLabel("Типы:", SwingConstants.RIGHT);
    lab.setBorder(BorderFactory.createEmptyBorder(0, 10, 0, 0));
    gbC = new GridBagConstraints();
    gbC.anchor = GridBagConstraints.EAST;
    gbC.fill = GridBagConstraints.HORIZONTAL;
    ...
    lab = new JLabel("Отсутствующие:", SwingConstants.RIGHT);
    ...
    lab = new JLabel("Различные:", SwingConstants.RIGHT);
    lab.setBorder(BorderFactory.createEmptyBorder(0, 10, 5, 0));
    gbC = new GridBagConstraints();
    gbC.anchor = GridBagConstraints.EAST;
    gbC.fill = GridBagConstraints.HORIZONTAL;
    ...
    lab = new JLabel("Единственные:", SwingConstants.RIGHT);
    lab.setBorder(BorderFactory.createEmptyBorder(0, 10, 5, 0));
    gbC = new GridBagConstraints();
    gbC.anchor = GridBagConstraints.EAST;
    gbC.fill = GridBagConstraints.HORIZONTAL;
