...
public class VisualizePanel
  ...
  protected JButton m_submit = new JButton("Отправить");
  
  /** Button for the user to remove all splits. */
  protected JButton m_cancel = new JButton("Очистить");

  /** Button for the user to open the visualized set of instances */
  protected JButton m_openBut = new JButton("Открыть");
  ...
  protected JLabel m_JitterLab= new JLabel("Детализация",SwingConstants.RIGHT);
...
//	  m_showAttBars = true;
  ...
  public VisualizePanel() {
    ...
    m_classSurround.
      setBorder(BorderFactory.createTitledBorder("Цвета кластеров")); 
  ...
  public void setUpComboBoxes(Instances inst) {
    ...
    m_plotSurround.setBorder((BorderFactory.createTitledBorder("График: "
			      +inst.relationName())));
    try {
      if (prefX != -1) {
	setXIndex(prefX);
