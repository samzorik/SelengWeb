...
public class AssociationsPanel extends JPanel implements
  ...
  public AssociationsPanel() {
    ...
    p1.setBorder(BorderFactory.createCompoundBorder(
        BorderFactory.createTitledBorder("Поиск ассоциативных правил"),
    ...
    p3.setBorder(BorderFactory.createTitledBorder("Результат"));
      ...
      m_RunThread = new Thread() {
        ...
        public void run() {
          ...
          try {
            ...
            outBuff.append("=== Ассоциативная модель (full training set) ===\n\n");
  ...
  public String getTabTitle() {
    return "Поиск ассоциативных правил";
  }
