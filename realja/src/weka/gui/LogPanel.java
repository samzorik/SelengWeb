...
public class LogPanel
  ...
  protected JLabel m_StatusLab = new JLabel("Готово");
  
  /** Displays the log messages */
  protected JTextArea m_LogText = new JTextArea(4, 20);

  /** The button for viewing the log */
  protected JButton m_logButton = new JButton("Лог");
...
//    m_TaskMonitor = tm;
    ...
    m_StatusLab.setBorder(BorderFactory.createCompoundBorder(
			  BorderFactory.createTitledBorder("Статус"),
    ...
    if (logHidden) {
      ...
      // create log window
      final JFrame jf = new JFrame("Лог");
