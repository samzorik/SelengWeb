...
import weka.gui.arffviewer.ArffPanel_for_clusters;
 ...
 */
public class ViewerDialog_for_clusters 
  extends JDialog 
  ...
  protected ArffPanel_for_clusters m_ArffPanel;// = new ArffPanel_for_clusters();
   ...
   */
  public ViewerDialog_for_clusters(Frame parent,Instances[] clus) {
    super(parent, ModalityType.DOCUMENT_MODAL);
    m_ArffPanel = new ArffPanel_for_clusters(clus);
    createDialog();
  }
