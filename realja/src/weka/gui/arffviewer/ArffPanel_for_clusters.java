...
public class ArffPanel_for_clusters 
  extends JPanel
  ...
  private JMenuItem             menuItemClusterShow;
  ...
  protected Instances []clus;
  
  /**
   * initializes the panel with no data
   */
  public ArffPanel_for_clusters() {
    super();
    
    initialize();
    createPanel();
  }
  public ArffPanel_for_clusters(Instances[] clus) {
	  super();
	  this.clus = clus;
	  initialize();
	  createPanel();
   ...
   */
  public ArffPanel_for_clusters(String filename, AbstractFileLoader... loaders) {
    this();
   ...
   */
  public ArffPanel_for_clusters(Instances data) {
    this();
  ...
  protected void createPanel() {
    ...
    menuItemClusterShow = new JMenuItem("Show cluster");
    menuItemClusterShow.addActionListener(this);
  ...
  private void initPopupMenus() {
    ...
    m_PopupRows.add(menuItemClusterShow);
    m_PopupRows.addSeparator();
  ...
  private void setMenu() {
    ...
    menuItemClusterShow.setEnabled(true);
  ...
  private void ClusterShow() {
	// TODO Auto-generated method stub
	  StringSelection      selection;
	    ...
	    if (index == -1)
	      return;
	    double temp =(double) m_TableArff.getValueAt(index, 1);
//	    System.out.println(temp);
	    ViewerDialog dialog = new ViewerDialog(null);
	    int result = dialog.showDialog(clus[(int)(temp)]);
}
