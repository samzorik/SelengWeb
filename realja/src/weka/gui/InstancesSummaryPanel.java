...
public class InstancesSummaryPanel extends JPanel {
  ...
  protected static final String NO_SOURCE = "Нет данных";
...
//  protected JLabel m_sumOfWeightsLab = new JLabel(NO_SOURCE);
  ...
  public InstancesSummaryPanel() {
    ...
    setLayout(gbLayout);
    JLabel lab = new JLabel("Отношение:", SwingConstants.RIGHT);
    ...
    lab = new JLabel("Объекты:", SwingConstants.RIGHT);
    lab.setBorder(BorderFactory.createEmptyBorder(0, 10, 0, 0));
    gbConstraints = new GridBagConstraints();
    gbConstraints.anchor = GridBagConstraints.EAST;
    gbConstraints.fill = GridBagConstraints.HORIZONTAL;
    ...
    lab = new JLabel("Атрибуты:", SwingConstants.RIGHT);
    lab.setBorder(BorderFactory.createEmptyBorder(0, 10, 0, 0));
    gbConstraints = new GridBagConstraints();
    gbConstraints.anchor = GridBagConstraints.EAST;
    gbConstraints.fill = GridBagConstraints.HORIZONTAL;
