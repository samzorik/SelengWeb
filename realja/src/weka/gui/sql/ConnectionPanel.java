...
public class ConnectionPanel 
  ...
  /** the URL to use. */
  protected String m_URL = "jdbc:firebirdsql:localhost/3050:C:\\Аспирантура\\Cinema_314.fdb";

  /** the user to use for connecting to the DB. */
  protected String m_User = "sysdba";

  /** the password to use for connecting to the DB. */
  protected String m_Password = "masterkey";
