 ...
 */
public class Discretize_up_and_sub_zero
  ...
  public Discretize_up_and_sub_zero() {
   ...
   */
  public Discretize_up_and_sub_zero(String cols) {
  ...
  public static void main(String [] argv) {
    runFilter(new Discretize_up_and_sub_zero(), argv);
  }
}
