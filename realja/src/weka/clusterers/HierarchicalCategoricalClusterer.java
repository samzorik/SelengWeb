...
*/
public class HierarchicalCategoricalClusterer extends AbstractClusterer implements OptionHandler, CapabilitiesHandler, Drawable {
...
//      fBestDist = m_DistanceFunction.distance(instance1, instance2);
  ...
  public static void main(String [] argv) {
    runClusterer(new HierarchicalCategoricalClusterer(), argv);
  }
  @Override
