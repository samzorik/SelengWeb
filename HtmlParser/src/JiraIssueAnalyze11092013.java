...
public class JiraIssueAnalyze11092013 {
...
//		System.out.print(result);
		...
		if (status.text().equalsIgnoreCase("Разрешён")||status.text().equalsIgnoreCase("Закрыт")) continue;
		Element author = doc.getElementById("reporter-val");
		Element assignee = doc.getElementById("assignee-val");
//		Elements listauthor=author.getElementsByTag("a");
		...
		Element header=doc.getElementById("summary-val");
...
//			}
//		}
		String t1=assignee.text(),t2=author.text();
		if(c.contains(author.text()))
		{
